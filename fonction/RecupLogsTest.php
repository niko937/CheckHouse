...
$dbname = "mydb";
<<<<<<< HEAD
//http://projets-tomcat.isep.fr:8080/appService?ACTION=GETLOG&TEAM=A12E
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://projets-tomcat.isep.fr:8080/appService?ACTION=GETLOG&TEAM=A12E");
=======
...
<<<<<<< HEAD
//Décomposer la chaîne de caractère en tableaux de trames
$TypeSearch = 1;
=======
...
for($i=count($data_tab)-23, $size=count($data_tab); $i<$size; $i++)
{
		...
		//{
			...
			if ($minute != $min) {
				...
				try
				{
					...
					VALUES ('$Valeur','$date',1,6,'$idPiece',1)";
					$conn->exec($sql);
