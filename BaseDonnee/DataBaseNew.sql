...
CREATE TABLE IF NOT EXISTS `mydb`.`Fonctionnalite` (
  ...
  `ReferenceFonction` VARCHAR(45) NULL,
  `CleProduit` INT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`FonctionRef`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`FonctionRef` (
  `idFonctionRef` INT NOT NULL AUTO_INCREMENT,
  `NomFonction` VARCHAR(45) NULL,
  `Reference` VARCHAR(45) NULL,
  PRIMARY KEY (`idFonctionRef`))
ENGINE = InnoDB;
